...
require (
	github.com/unxed/archives v0.0.0-20260627213031-e5dbece9200b
	github.com/unxed/par2 v0.1.2
	github.com/unxed/tar v0.1.109
...
require (
	...
	github.com/unxed/sevenzip v0.0.0-20260627212954-72dd78b0f246 // indirect
