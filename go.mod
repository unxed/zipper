module github.com/unxed/zipper

go 1.25.5

require (
	github.com/unxed/archives v0.0.0-20260624173909-a39ace00cd83
...
require (
	...
	github.com/unxed/sevenzip v0.0.0-20260624173604-e06095c33b71 // indirect
	github.com/unxed/xz v0.1.15 // indirect
